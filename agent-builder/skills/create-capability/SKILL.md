...
`attic/archive-v1/artifact-plane/workspace/pre-implementation/` holds the planning sequence for the tien-os workspace itself — the repo
...
The alternative it rejected was flat `attic/archive-v1/artifact-plane/workspace/pre-implementation/` told apart by filename; the reason given
...
in `attic/archive-v1/artifact-plane/workspace/pre-implementation/2026-07-23-explainer-evidence.html`. **"Tiên asked for an agent" is
...
`engine/templates/agent-plugin-spec.md` ·
`attic/archive-v1/artifact-plane/workspace/pre-implementation/2026-07-23-explainer-evidence.html`
