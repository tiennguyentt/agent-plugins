...
| Path | Author | Licence |
|---|---|---|
| `skills/no-ai-slop/` | Peter G Yang — <https://github.com/petergyang/no-ai-slop> | MIT, that author's copyright |

`skills/no-ai-slop/NOTICE.md` is the full attribution and the file to read before
redistributing. It sits inside the skill folder because MIT requires the notice travel with
the copy; this root notice exists so a reader who opens the package sees the claim without
having to walk into a skill.
