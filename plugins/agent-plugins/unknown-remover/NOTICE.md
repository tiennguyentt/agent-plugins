...
| `README.md` | the corpus's own entry document | `artifacts/capabilities/unknown-remover/provenance/`, outside the package |
...
`artifacts/capabilities/unknown-remover/provenance/`, the four broken addresses are recorded in §3
...
any install; it sits outside the package at `artifacts/capabilities/unknown-remover/provenance/`.
...
package to `artifacts/capabilities/unknown-remover/provenance/`. Both files still exist there;
