...
description: >
  ...
  It never runs the evaluation it designs and never grades its own output.
model: inherit
tools:
  - Read
  - Grep
...
> `plugins/agent-plugins/eval-writer/skills/write-success-criteria/SKILL.md`. Read that one instead.
