...
supplied by Tiên on 2026-07-31. The prose is reproduced intact; the multi-language code samples
...
- The repository `LICENSE` (MIT, © 2026 Tien Nguyen) covers Tiên's work in this plugin — the
...
- The file is reference material the skill reads, never binding law:
  `control-plane/GUARDRAILS.md` §9 rule 3.
